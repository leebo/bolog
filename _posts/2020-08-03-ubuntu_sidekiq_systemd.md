---
layout: post
title: ubuntu server 18.04生产环境sidekiq systemd rvm自启配置
date: 2020-07-29
summary: ubuntu ruby ruby_on_rails sidekiq rvm
categories: work
---
...
WorkingDirectory=/var/www/weixin_api/current
# If you use rbenv:
# ExecStart=/bin/bash -lc 'exec /home/deploy/.rbenv/shims/bundle exec sidekiq -e production'
# If you use the system's ruby:
ExecStart=/home/deployer/.rvm/wrappers/my_app/bundle exec sidekiq -e production
